...
public class TestAgendaGsonSectionResponseParser {
    ...
    public void test() throws Exception {
        ...
        Section<AgendaItem> section = response.getSection();
        ...
        List<AgendaItem> items = section.getItems();
        assertNotNull(items);
        assertEquals(2, items.size());

        AgendaItem item0 = items.get(0);
        assertNotNull(item0);
