...
public class ThisApplication extends Application {
    ...
    private void initLogging() {
        ...
        logger = Logging.getLogger(ThisApplication.class);
    ...
    private void initDagger() {
        ...
        try {
            ...
            Singletons.deps = factory.newInstance(this);
        }
        catch (Exception e) {
    ...
    private void initEventBus() {
        Bus bus = Singletons.deps.getBus();
        EventDataSource source = Singletons.deps.getEventDataSource();
        bus.register(source);
    }
