...
public interface EventmobiModuleInterface {

    EventmobiConfig provideEventmobiConfig(Application context);
    EventmobiApi provideEventmobiApi(EventmobiConfig config);
