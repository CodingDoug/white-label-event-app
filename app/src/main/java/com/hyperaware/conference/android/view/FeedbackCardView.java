...
public abstract class FeedbackCardView extends CardView {
    ...
    public FeedbackCardView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setQuestionText(CharSequence s) {
